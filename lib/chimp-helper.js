  ...
  setupBrowserAndDDP: function () {
    ...
    var setupBrowser = function () {
      ...
      if (fs.existsSync(customChimpConfigPath)) {
        ...
        if (typeof process.env['chimp.version'] !== "undefined") {
            webdriverOptions.desiredCapabilities.version = process.env['chimp.version'];
        }

        if (typeof process.env['chimp.build'] !== "undefined") {
            webdriverOptions.desiredCapabilities.build = process.env['chimp.build'];
        }
